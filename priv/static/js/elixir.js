System.register([], function (_export) {
  ...
  var Type, object, Match, _fun, BitString, Erlang, Tuple, SpecialForms, Kernel, Atom, Enum, Integer, JS, List, Range, Keyword, Agent;
  ...
  return {
    ...
    execute: function () {
      ...
      Range = function Range(_first, _last) {
      ...
      _export('Erlang', Erlang);

      _export('BitString', BitString);

      _export('Kernel', Kernel);
